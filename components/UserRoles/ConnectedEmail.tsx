        ...
        <li className="w-full">
          <div className="flex items-start">
            ...
            <div className="mt-[-4px]">
              ...
              <div className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-white border border-primary-300 shadow-xs text-[#101828] w-[100%] lg:w-[488px]">
                <MailIcon className="text-sm" />
                <input
                  className="text-[16px] ml-4 max-w-full bg-transparent focus:outline-none"
                />
              </div>
            </div>
          </div>
